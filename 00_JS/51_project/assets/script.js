...
document.addEventListener('DOMContentLoaded', () => {
	...
	let scoreText = {
		...
		draw : function () {
			...
			ctx.fillText(`Total sampah yang dikumpulkan : ${score}`, x, y);	
	...
	const gameOverText = {
		...
		draw : function (){
			...
			ctx.textAlign = this.align;
			ctx.textBaseline = this.baseline;
			ctx.fillText(`Sampah yang kamu kumpulkan adalah sebanyak ${score}`, x, y);
	...
	class Snake{
		...
		draw() {
			...
			this.segments.forEach( (segment) => {
				segment.drawSquare("Light Brown");
			} )
